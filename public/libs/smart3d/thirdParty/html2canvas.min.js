...
!(function(A, e) {
          ...
          for (; o; )
            try {
              if (
                ((n = 1),
                B &&
                  (s = 2 & e[0] ? B.return : e[0] ? B.throw || ((s = B.return) && s.call(B), 0) : B.next) &&
                  !(s = s.call(B, e[1])).done)
              )
                return s;
  ...
  function u(A, e, t, r, n) {
    ...
    if (8 === g(B, e)) return '÷';
    if (11 === q.get(A[B]) && (c === X || c === x || c === P)) return Y;
    if (7 === i || 7 === c) return Y;
    if (9 === i) return Y;
    if (-1 === [d, H, f].indexOf(i) && 9 === c) return Y;
    if (-1 !== [p, N, m, D, y].indexOf(c)) return Y;
    if (g(B, e) === O) return Y;
    ...
    if (16 === c || 16 === i) return '÷';
    if (-1 !== [H, f, L].indexOf(c) || 14 === i) return Y;
    if (36 === a && -1 !== rA.indexOf(i)) return Y;
    if (i === y && 36 === c) return Y;
    if (c === R && -1 !== Z.concat(R, m, b, X, x, P).indexOf(i)) return Y;
    if ((-1 !== Z.indexOf(c) && i === b) || (-1 !== Z.indexOf(i) && c === b)) return Y;
    if ((i === M && -1 !== [X, x, P].indexOf(c)) || (-1 !== [X, x, P].indexOf(i) && c === v)) return Y;
    if ((-1 !== Z.indexOf(i) && -1 !== AA.indexOf(c)) || (-1 !== AA.indexOf(i) && -1 !== Z.indexOf(c))) return Y;
    if (
      (-1 !== [M, v].indexOf(i) && (c === b || (-1 !== [O, f].indexOf(c) && e[1 + o] === b))) ||
      (-1 !== [O, f].indexOf(i) && c === b) ||
      (i === b && -1 !== [b, y, D].indexOf(c))
    )
      return Y;
    if (-1 !== [b, y, D, p, N].indexOf(c))
      for (var Q = B; 0 <= Q; ) {
        if ((u = e[Q]) === b) return Y;
        if (-1 === [y, D].indexOf(u)) break;
        Q--;
      }
    if (-1 !== [M, v].indexOf(c))
    ...
    if (
      (G === i && -1 !== [G, J, V, z].indexOf(c)) ||
      (-1 !== [J, V].indexOf(i) && -1 !== [J, k].indexOf(c)) ||
      (-1 !== [k, z].indexOf(i) && c === k)
    )
      return Y;
    if ((-1 !== tA.indexOf(i) && -1 !== [R, v].indexOf(c)) || (-1 !== tA.indexOf(c) && i === M)) return Y;
    if (-1 !== Z.indexOf(i) && -1 !== Z.indexOf(c)) return Y;
    if (i === D && -1 !== Z.indexOf(c)) return Y;
    if ((-1 !== Z.concat(b).indexOf(i) && c === O) || (-1 !== Z.concat(b).indexOf(c) && i === N)) return Y;
    if (41 === i && 41 === c) {
      for (var w = t[B], U = 1; 0 < w && 41 === e[--w]; ) U++;
      if (U % 2 != 0) return Y;
    }
    return i === x && c === P ? Y : '÷';
  }
  ...
  function UA(A, e, t) {
    return 45 === A ? QA(e) || wA(e, t) : !!QA(A) || !(92 !== A || !wA(A, e));
  }
  function lA(A, e, t) {
  ...
  var CA = { type: sA.LEFT_PARENTHESIS_TOKEN },
    ...
    hA = { type: sA.SUFFIX_MATCH_TOKEN },
    FA = { type: sA.PREFIX_MATCH_TOKEN },
    dA = { type: sA.COLUMN_TOKEN },
    HA = { type: sA.DASH_MATCH_TOKEN },
    ...
    DA = { type: sA.LEFT_SQUARE_BRACKET_TOKEN },
    bA = { type: sA.RIGHT_SQUARE_BRACKET_TOKEN },
    vA = { type: sA.WHITESPACE_TOKEN },
    ...
    MA =
      ...
      (yA.prototype.consumeToken = function() {
        ...
        switch (A) {
          ...
          case 64:
            ...
            if (UA(c, Q, u)) return (B = this.consumeName()), { type: sA.AT_KEYWORD_TOKEN, value: B };
            break;
          case 91:
            return DA;
          case 92:
          ...
          case 85:
            ...
            return (
              43 !== w || (!aA(U) && 63 !== U) || (this.consumeCodePoint(), this.consumeUnicodeRangeToken()),
      ...
      (yA.prototype.consumeUrlToken = function() {
        ...
        for (;;) {
          ...
          if (92 === n) {
            if (!wA(n, this.peekCodePoint(0))) return this.consumeBadUrlRemnants(), IA;
          ...
          if (92 === r) {
            ...
            -1 !== n &&
              ...
              (10 === n
                ...
                : wA(r, n) && ((e += this.consumeStringSlice(t)), (e += l(this.consumeEscapedCodePoint())), (t = -1)));
          }
          t++;
        }
      }),
  ...
  function $A(A) {
    return (
      A.type === sA.DIMENSION_TOKEN && ('deg' === A.unit || 'grad' === A.unit || 'rad' === A.unit || 'turn' === A.unit)
    );
  }
  function Ae(A) {
    switch (
    ...
    ue = function(A) {
      ...
      if (A.type === sA.HASH_TOKEN) {
        if (3 === A.value.length) {
          ...
          return we(parseInt(t + t, 16), parseInt(r + r, 16), parseInt(n + n, 16), 1);
        }
        if (4 === A.value.length) {
          (t = A.value.substring(0, 1)), (r = A.value.substring(1, 2)), (n = A.value.substring(2, 3));
          var B = A.value.substring(3, 4);
          return we(parseInt(t + t, 16), parseInt(r + r, 16), parseInt(n + n, 16), parseInt(B + B, 16) / 255);
        }
        if (6 === A.value.length) {
          (t = A.value.substring(0, 2)), (r = A.value.substring(2, 4)), (n = A.value.substring(4, 6));
          return we(parseInt(t, 16), parseInt(r, 16), parseInt(n, 16), 1);
        }
        if (8 === A.value.length) {
          ...
          return we(parseInt(t, 16), parseInt(r, 16), parseInt(n, 16), parseInt(B, 16) / 255);
        }
      }
  ...
  function le(A) {
    ...
    if (0 == o) return we(255 * i, 255 * i, 255 * i, 1);
    var c = i <= 0.5 ? i * (1 + o) : i + o - i * o,
      Q = 2 * i - c,
      u = Ue(Q, c, s + 1 / 3),
      w = Ue(Q, c, s),
      U = Ue(Q, c, s - 1 / 3);
    return we(255 * u, 255 * w, 255 * U, a);
  }
  var Ce,
    ge,
    Ee,
    he,
    Fe = { hsl: le, hsla: le, rgb: ne, rgba: ne },
    de = {
  ...
  ((ge = Ce || (Ce = {}))[(ge.VALUE = 0)] = 'VALUE'),
    ...
    ((he = Ee || (Ee = {}))[(he.BORDER_BOX = 0)] = 'BORDER_BOX'),
  ...
  function fe(A, t) {
    ...
    for (s = 0; s < n.length; s++) {
      ...
      if (null === c) null === a && (a = s);
        ...
        for (var Q = s - a, u = (c - n[a - 1]) / (1 + Q), w = 1; w <= Q; w++) n[a + w - 1] = u * w;
        a = null;
      }
    }
  ...
  function Ie(A) {
    ...
    return (
      ...
      { angle: n, stops: B, type: Pe.LINEAR_GRADIENT }
    );
  }
  function Te(A) {
  ...
  var me = {
    ...
    De = {
      get SUPPORT_RANGE_BOUNDS() {
        ...
        return Object.defineProperty(De, 'SUPPORT_RANGE_BOUNDS', { value: A }), A;
      },
      get SUPPORT_SVG_DRAWING() {
        ...
        return Object.defineProperty(De, 'SUPPORT_SVG_DRAWING', { value: A }), A;
      },
      get SUPPORT_FOREIGNOBJECT_DRAWING() {
        var A =
          'function' == typeof Array.from && 'function' == typeof window.fetch
            ...
            : Promise.resolve(!1);
        return Object.defineProperty(De, 'SUPPORT_FOREIGNOBJECT_DRAWING', { value: A }), A;
      },
      get SUPPORT_CORS_IMAGES() {
        var A = void 0 !== new Image().crossOrigin;
        return Object.defineProperty(De, 'SUPPORT_CORS_IMAGES', { value: A }), A;
      },
      get SUPPORT_RESPONSE_TYPE() {
        var A = 'string' == typeof new XMLHttpRequest().responseType;
        return Object.defineProperty(De, 'SUPPORT_RESPONSE_TYPE', { value: A }), A;
      },
      get SUPPORT_CORS_XHR() {
        var A = 'withCredentials' in new XMLHttpRequest();
        return Object.defineProperty(De, 'SUPPORT_CORS_XHR', { value: A }), A;
      },
    },
    be =
      ...
      (ve.create = function(A) {
        ve.instances[A.id] = new ve(A);
      }),
      (ve.destroy = function(A) {
        delete ve.instances[A];
      }),
      (ve.getInstance = function(A) {
        var e = ve.instances[A];
  ...
  var ye =
    ((_e.prototype.addImage = function(A) {
      ...
      return this.has(A) || ((Ye(A) || Je(A)) && (this._cache[A] = this.loadImage(A))), e;
    }),
        ...
        return S(this, function(A) {
          switch (A.label) {
            case 0:
              return (
                (e = Se.isSameOrigin(s)),
                (r = !ke(s) && !0 === this._options.useCORS && De.SUPPORT_CORS_IMAGES && !e),
                (t = !ke(s) && !e && 'string' == typeof this._options.proxy && De.SUPPORT_CORS_XHR && !r),
            ...
            case 2:
              return (
                be.getInstance(this.id).debug('Added image ' + s.substring(0, 256)),
                [
                  4,
    ...
    (_e.prototype.proxy = function(B) {
      ...
      return new Promise(function(e, t) {
        var r = De.SUPPORT_RESPONSE_TYPE ? 'blob' : 'text',
  ...
  function xe(A) {
    ...
    return (
      ...
      { size: B, shape: n, stops: s, position: o, type: Pe.RADIAL_GRADIENT }
    );
  }
  var Pe,
    Ve,
    ...
    Ge = /^data:image\/.*/i,
    Je = function(A) {
      return De.SUPPORT_SVG_DRAWING || !qe(A);
    },
    ke = function(A) {
      return Ge.test(A);
    },
    ...
    ct = {
      ...
      'radial-gradient': function(A) {
        ...
        return (
          ...
          { size: s, shape: B, stops: o, position: i, type: Pe.RADIAL_GRADIENT }
        );
      },
      ...
      '-webkit-gradient': function(A) {
        ...
        return (
          WA(A).forEach(function(A, e) {
            var t = A[0];
            if (0 === e) {
              if (zA(t) && 'linear' === t.value) return void (o = Pe.LINEAR_GRADIENT);
              if (zA(t) && 'radial' === t.value) return void (o = Pe.RADIAL_GRADIENT);
            }
            if (t.type === sA.FUNCTION)
              if ('from' === t.name) {
                var r = ue(t.values[0]);
                s.push({ stop: se, color: r });
              } else if ('to' === t.name) (r = ue(t.values[0])), s.push({ stop: ie, color: r });
                ...
                if (2 === n.length) {
                  ...
                  var B = n[0];
                  VA(B) &&
                    s.push({ stop: { type: sA.PERCENTAGE_TOKEN, number: 100 * B.number, flags: B.flags }, color: r });
                }
              }
          }),
          o === Pe.LINEAR_GRADIENT
  ...
  var Ft,
    ...
    Rt = ht('bottom-right'),
    Lt = ht('bottom-left');
  ((dt = Ft || (Ft = {}))[(dt.NONE = 0)] = 'NONE'),
    (dt[(dt.SOLID = 1)] = 'SOLID'),
    (dt[(dt.DASHED = 2)] = 'DASHED'),
    (dt[(dt.DOTTED = 3)] = 'DOTTED'),
    (dt[(dt.DOUBLE = 4)] = 'DOUBLE');
  function Ot(A) {
    return {
      name: 'border-' + A + '-style',
      initialValue: 'solid',
  ...
  ((vt = bt || (bt = {}))[(vt.NONE = 0)] = 'NONE'),
    (vt[(vt.LEFT = 1)] = 'LEFT'),
    (vt[(vt.RIGHT = 2)] = 'RIGHT'),
    (vt[(vt.INLINE_START = 3)] = 'INLINE_START');
  var kt,
    Wt,
    Yt,
    qt,
    Zt = {
      name: 'float',
      initialValue: 'none',
      prefix: !(vt[(vt.INLINE_END = 4)] = 'INLINE_END'),
      type: Ce.IDENT_VALUE,
      parse: function(A) {
        switch (A) {
          case 'left':
    ...
    Rr = {
      ...
      parse: function(A) {
        return 1 === A.length && GA(A[0], 'none')
          ...
          : WA(A).map(function(A) {
              for (
                var e = { color: de.TRANSPARENT, offsetX: se, offsetY: se, blur: se }, t = 0, r = 0;
                r < A.length;
                r++
              ) {
                var n = A[r];
                YA(n) ? (0 === t ? (e.offsetX = n) : 1 === t ? (e.offsetY = n) : (e.blur = n), t++) : (e.color = ue(n));
              }
              return e;
            });
      },
  ...
  ((xr = _r || (_r = {})).NORMAL = 'normal'), (xr.BREAK_ALL = 'break-all');
  var Vr,
    zr,
    Xr = {
      name: 'word-break',
  ...
  var en = {
    ...
    sn = {
      ...
      parse: function(A) {
        return 1 === A.length && GA(A[0], 'none')
          ...
          : WA(A).map(function(A) {
              for (
                var e = { color: 255, offsetX: se, offsetY: se, blur: se, spread: se, inset: !1 }, t = 0, r = 0;
                r < A.length;
                r++
              ) {
                var n = A[r];
                GA(n, 'inset')
                  ? (e.inset = !0)
                  : YA(n)
                  ? (0 === t ? (e.offsetX = n) : 1 === t ? (e.offsetY = n) : 2 === t ? (e.blur = n) : (e.spread = n),
                    t++)
                  : (e.color = ue(n));
              }
              return e;
    ...
    on =
      ...
      an);
  function an(A) {
    (this.backgroundClip = wn(me, A.backgroundClip)),
      (this.backgroundColor = wn(Re, A.backgroundColor)),
      (this.backgroundImage = wn(Qt, A.backgroundImage)),
      (this.backgroundOrigin = wn(ut, A.backgroundOrigin)),
      (this.backgroundPosition = wn(wt, A.backgroundPosition)),
      (this.backgroundRepeat = wn(Ct, A.backgroundRepeat)),
      (this.backgroundSize = wn(Ht, A.backgroundSize)),
      (this.borderTopColor = wn(pt, A.borderTopColor)),
      (this.borderRightColor = wn(Nt, A.borderRightColor)),
      (this.borderBottomColor = wn(Kt, A.borderBottomColor)),
      (this.borderLeftColor = wn(It, A.borderLeftColor)),
      (this.borderTopLeftRadius = wn(Tt, A.borderTopLeftRadius)),
      (this.borderTopRightRadius = wn(mt, A.borderTopRightRadius)),
      (this.borderBottomRightRadius = wn(Rt, A.borderBottomRightRadius)),
      (this.borderBottomLeftRadius = wn(Lt, A.borderBottomLeftRadius)),
      (this.borderTopStyle = wn(St, A.borderTopStyle)),
      (this.borderRightStyle = wn(Mt, A.borderRightStyle)),
      (this.borderBottomStyle = wn(yt, A.borderBottomStyle)),
      (this.borderLeftStyle = wn(_t, A.borderLeftStyle)),
      (this.borderTopWidth = wn(xt, A.borderTopWidth)),
      (this.borderRightWidth = wn(Pt, A.borderRightWidth)),
      (this.borderBottomWidth = wn(Vt, A.borderBottomWidth)),
      (this.borderLeftWidth = wn(zt, A.borderLeftWidth)),
      (this.boxShadow = wn(sn, A.boxShadow)),
      (this.color = wn(Xt, A.color)),
      (this.display = wn(Gt, A.display)),
      (this.float = wn(Zt, A.cssFloat)),
      (this.fontFamily = wn(Yr, A.fontFamily)),
      (this.fontSize = wn(qr, A.fontSize)),
      (this.fontStyle = wn(en, A.fontStyle)),
      (this.fontVariant = wn(jr, A.fontVariant)),
      (this.fontWeight = wn(Zr, A.fontWeight)),
      (this.letterSpacing = wn(jt, A.letterSpacing)),
      (this.lineBreak = wn($t, A.lineBreak)),
      (this.lineHeight = wn(Ar, A.lineHeight)),
      (this.listStyleImage = wn(er, A.listStyleImage)),
      (this.listStylePosition = wn(nr, A.listStylePosition)),
      (this.listStyleType = wn(ir, A.listStyleType)),
      (this.marginTop = wn(ar, A.marginTop)),
      (this.marginRight = wn(cr, A.marginRight)),
      (this.marginBottom = wn(Qr, A.marginBottom)),
      (this.marginLeft = wn(ur, A.marginLeft)),
      (this.opacity = wn(Jr, A.opacity));
    var e = wn(Er, A.overflow);
    (this.overflowX = e[0]),
      (this.overflowY = e[1 < e.length ? 1 : 0]),
      (this.overflowWrap = wn(hr, A.overflowWrap)),
      (this.paddingTop = wn(Fr, A.paddingTop)),
      (this.paddingRight = wn(dr, A.paddingRight)),
      (this.paddingBottom = wn(Hr, A.paddingBottom)),
      (this.paddingLeft = wn(fr, A.paddingLeft)),
      (this.position = wn(mr, A.position)),
      (this.textAlign = wn(Kr, A.textAlign)),
      (this.textDecorationColor = wn(kr, A.textDecorationColor || A.color)),
      (this.textDecorationLine = wn(Wr, A.textDecorationLine)),
      (this.textShadow = wn(Rr, A.textShadow)),
      (this.textTransform = wn(Dr, A.textTransform)),
      (this.transform = wn(br, A.transform)),
      (this.transformOrigin = wn(yr, A.transformOrigin)),
      (this.visibility = wn(Pr, A.visibility)),
      (this.wordBreak = wn(Xr, A.wordBreak)),
      (this.zIndex = wn(Gr, A.zIndex));
  }
  var cn,
    Qn = function(A) {
      (this.content = wn(tn, A.content)), (this.quotes = wn(Bn, A.quotes));
    },
    un = function(A) {
      (this.counterIncrement = wn(rn, A.counterIncrement)), (this.counterReset = wn(nn, A.counterReset));
    },
    wn = function(A, e) {
      var t = new MA(),
          ...
          r = (function(A, e) {
            ...
            return {
              next: function() {
                ...
                for (var A = Y; a < o && (A = u(t, B, n, ++a, s)) === Y; );
          ...
          return (
            e.forEach(function(A) {
              if (t.textDecorationLine.length || 0 < A.trim().length)
                if (De.SUPPORT_RANGE_BOUNDS) n.push(new ln(A, gn(r, B, A.length)));
                else {
                  var e = r.splitText(A.length);
                  n.push(new ln(A, Cn(r))), (r = e);
                }
              else De.SUPPORT_RANGE_BOUNDS || (r = r.splitText(A.length));
              B += A.length;
            }),
            n
          );
  ...
  function $n(A) {
    return ue(_A.create(A).parseComponentValue());
  }
  var AB,
    eB = (A(tB, (AB = Un)), tB);
  function tB(A) {
      ...
      if (A.contentWindow && A.contentWindow.document && A.contentWindow.document.documentElement) {
        ...
        var t = A.contentWindow.document.documentElement
          ...
          r = A.contentWindow.document.body
            ? $n(getComputedStyle(A.contentWindow.document.body).backgroundColor)
            : de.TRANSPARENT;
  ...
  var nB = ['OL', 'UL', 'MENU'],
    BB = function(A, e, t) {
      for (var r = A.firstChild, n = void 0; r; r = n)
        if (((n = r.nextSibling), cB(r) && 0 < r.data.trim().length)) e.textNodes.push(new Fn(r, e.styles));
        else if (QB(r)) {
          var B = sB(r);
          B.styles.isVisible() &&
    ...
    uB = function(A) {
      return QB(A) && void 0 !== A.style && !wB(A);
    },
    wB = function(A) {
  ...
  var LB,
    ...
    yB = function(A, e, t) {
      ...
      switch (e) {
        ...
        case tr.LOWER_ROMAN:
          return KB(A, 1, 3999, DB, tr.DECIMAL, r).toLowerCase();
        case tr.UPPER_ROMAN:
          return KB(A, 1, 3999, DB, tr.DECIMAL, r);
        case tr.LOWER_GREEK:
        ...
        case tr.UPPER_ARMENIAN:
          return KB(A, 1, 9999, bB, tr.DECIMAL, r);
        case tr.LOWER_ARMENIAN:
          return KB(A, 1, 9999, bB, tr.DECIMAL, r).toLowerCase();
        case tr.BENGALI:
        ...
        case tr.HEBREW:
          return KB(A, 1, 10999, vB, tr.DECIMAL, r);
        case tr.HIRAGANA:
          return mB(
            A,
    ...
    xB =
      ((PB.prototype.toIFrame = function(A, t) {
        var e = this,
          r = XB(A, t);
      ...
      (PB.prototype.createElementClone = function(A) {
        if (hB(A)) return this.createCanvasClone(A);
        if (rB(A)) return this.createStyleClone(A);
        var e = A.cloneNode(!1);
        return FB(e) && 'lazy' === e.loading && (e.loading = 'eager'), e;
      }),
      (PB.prototype.createStyleClone = function(A) {
        try {
          var e = A.sheet;
          if (e && e.cssRules) {
          ...
          if (
            (be.getInstance(this.options.id).error('Unable to access cssRules property', A), 'SecurityError' !== A.name)
          )
            throw A;
        }
        return A.cloneNode(!1);
      }),
      (PB.prototype.createCanvasClone = function(A) {
        if (this.options.inlineImages && A.ownerDocument) {
          var e = A.ownerDocument.createElement('img');
          try {
            return (e.src = A.toDataURL()), e;
          } catch (A) {
            be.getInstance(this.options.id).info('Unable to clone canvas contents, canvas is tainted');
          }
        }
        var t = A.cloneNode(!1);
        try {
      ...
      (PB.prototype.cloneNode = function(A) {
        ...
        if (e && QB(A) && (uB(A) || wB(A))) {
          ...
          this.referenceElement === A && uB(t) && (this.clonedReferenceElement = t), EB(t) && $B(t);
          for (
            var s = this.counters.parse(new un(r)), o = this.resolvePseudoContent(A, t, n, LB.BEFORE), i = A.firstChild;
            i;
            i = i.nextSibling
          )
            (QB(i) &&
          ...
          return (
            a && t.appendChild(a),
            this.counters.pop(s),
            r && (this.options.copyStyles || wB(A)) && !dB(A) && JB(r, t),
            (0 === A.scrollTop && 0 === A.scrollLeft) || this.scrolledElements.push([t, A.scrollLeft, A.scrollTop]),
            (HB(A) || fB(A)) && (HB(t) || fB(t)) && (t.value = A.value),
            t
          );
        }
        return A.cloneNode(!1);
      }),
      (PB.prototype.resolvePseudoContent = function(U, A, e, t) {
        var l = this;
        if (e) {
          var r = e.content,
            C = A.ownerDocument;
          if (C && r && 'none' !== r && '-moz-alt-content' !== r && 'none' !== e.display) {
                  ...
                  if ('attr' === A.name) {
                    ...
                    if (((B = i[2]), n && zA(n))) {
                      var c = l.counters.getCounterValues(n.value),
                        ...
                        u = a && a.type === sA.STRING_TOKEN ? a.value : '',
                        w = c
                          .map(function(A) {
                            return yB(A, Q, !1);
                          })
                          .join(u);
                      E.appendChild(C.createTextNode(w));
                    }
                  }
            ...
            return wB(A) ? (A.className.baseValue += n) : (A.className += n), E;
          }
        }
      }),
      (PB.destroy = function(A) {
  ...
  var is,
    ...
    cs = function(A) {
      ...
      (this.topLeftBorderDoubleOuterBox =
        0 < n || 0 < B
          ? ws(t.left + p / 3, t.top + d / 3, n - p / 3, B - d / 3, is.TOP_LEFT)
          : new ts(t.left + p / 3, t.top + d / 3)),
        (this.topRightBorderDoubleOuterBox =
          0 < n || 0 < B
            ? ws(t.left + g, t.top + d / 3, o - H / 3, i - d / 3, is.TOP_RIGHT)
            : new ts(t.left + t.width - H / 3, t.top + d / 3)),
        (this.bottomRightBorderDoubleOuterBox =
          0 < c || 0 < Q
            ? ws(t.left + h, t.top + E, c - H / 3, Q - f / 3, is.BOTTOM_RIGHT)
            : new ts(t.left + t.width - H / 3, t.top + t.height - f / 3)),
        (this.bottomLeftBorderDoubleOuterBox =
          0 < w || 0 < U
            ? ws(t.left + p / 3, t.top + F, w - p / 3, U - f / 3, is.BOTTOM_LEFT)
            : new ts(t.left + p / 3, t.top + t.height - f / 3)),
        (this.topLeftBorderDoubleInnerBox =
          0 < n || 0 < B
            ? ws(t.left + (2 * p) / 3, t.top + (2 * d) / 3, n - (2 * p) / 3, B - (2 * d) / 3, is.TOP_LEFT)
            : new ts(t.left + (2 * p) / 3, t.top + (2 * d) / 3)),
        (this.topRightBorderDoubleInnerBox =
          0 < n || 0 < B
            ? ws(t.left + g, t.top + (2 * d) / 3, o - (2 * H) / 3, i - (2 * d) / 3, is.TOP_RIGHT)
            : new ts(t.left + t.width - (2 * H) / 3, t.top + (2 * d) / 3)),
        (this.bottomRightBorderDoubleInnerBox =
          0 < c || 0 < Q
            ? ws(t.left + h, t.top + E, c - (2 * H) / 3, Q - (2 * f) / 3, is.BOTTOM_RIGHT)
            : new ts(t.left + t.width - (2 * H) / 3, t.top + t.height - (2 * f) / 3)),
        (this.bottomLeftBorderDoubleInnerBox =
          0 < w || 0 < U
            ? ws(t.left + (2 * p) / 3, t.top + F, w - (2 * p) / 3, U - (2 * f) / 3, is.BOTTOM_LEFT)
            : new ts(t.left + (2 * p) / 3, t.top + t.height - (2 * f) / 3)),
        (this.topLeftBorderStroke =
          0 < n || 0 < B
            ? ws(t.left + p / 2, t.top + d / 2, n - p / 2, B - d / 2, is.TOP_LEFT)
            : new ts(t.left + p / 2, t.top + d / 2)),
        (this.topRightBorderStroke =
          0 < n || 0 < B
            ? ws(t.left + g, t.top + d / 2, o - H / 2, i - d / 2, is.TOP_RIGHT)
            : new ts(t.left + t.width - H / 2, t.top + d / 2)),
        (this.bottomRightBorderStroke =
          0 < c || 0 < Q
            ? ws(t.left + h, t.top + E, c - H / 2, Q - f / 2, is.BOTTOM_RIGHT)
            : new ts(t.left + t.width - H / 2, t.top + t.height - f / 2)),
        (this.bottomLeftBorderStroke =
          0 < w || 0 < U
            ? ws(t.left + p / 2, t.top + F, w - p / 2, U - f / 2, is.BOTTOM_LEFT)
            : new ts(t.left + p / 2, t.top + t.height - f / 2)),
        (this.topLeftBorderBox = 0 < n || 0 < B ? ws(t.left, t.top, n, B, is.TOP_LEFT) : new ts(t.left, t.top)),
        (this.topRightBorderBox =
          0 < o || 0 < i ? ws(t.left + g, t.top, o, i, is.TOP_RIGHT) : new ts(t.left + t.width, t.top)),
        (this.bottomRightBorderBox =
          0 < c || 0 < Q
            ? ws(t.left + h, t.top + E, c, Q, is.BOTTOM_RIGHT)
            : new ts(t.left + t.width, t.top + t.height)),
        (this.bottomLeftBorderBox =
          0 < w || 0 < U ? ws(t.left, t.top + F, w, U, is.BOTTOM_LEFT) : new ts(t.left, t.top + t.height)),
        (this.topLeftPaddingBox =
          0 < n || 0 < B
            ? ws(t.left + p, t.top + d, Math.max(0, n - p), Math.max(0, B - d), is.TOP_LEFT)
            : new ts(t.left + p, t.top + d)),
        (this.topRightPaddingBox =
          0 < o || 0 < i
            ? ws(
                t.left + Math.min(g, t.width - H),
                t.top + d,
                g > t.width + H ? 0 : Math.max(0, o - H),
                Math.max(0, i - d),
                is.TOP_RIGHT
              )
            : new ts(t.left + t.width - H, t.top + d)),
        (this.bottomRightPaddingBox =
          0 < c || 0 < Q
            ? ws(
                t.left + Math.min(h, t.width - p),
                t.top + Math.min(E, t.height - f),
                Math.max(0, c - H),
                Math.max(0, Q - f),
                is.BOTTOM_RIGHT
              )
            : new ts(t.left + t.width - H, t.top + t.height - f)),
        (this.bottomLeftPaddingBox =
          0 < w || 0 < U
            ? ws(t.left + p, t.top + Math.min(F, t.height - f), Math.max(0, w - p), Math.max(0, U - f), is.BOTTOM_LEFT)
            : new ts(t.left + p, t.top + t.height - f)),
        (this.topLeftContentBox =
          0 < n || 0 < B
            ? ws(t.left + p + T, t.top + d + N, Math.max(0, n - (p + T)), Math.max(0, B - (d + N)), is.TOP_LEFT)
            : new ts(t.left + p + T, t.top + d + N)),
        (this.topRightContentBox =
          0 < o || 0 < i
            ...
            : new ts(t.left + t.width - (H + K), t.top + d + N)),
        (this.bottomRightContentBox =
          0 < c || 0 < Q
            ? ws(
                t.left + Math.min(h, t.width - (p + T)),
                t.top + Math.min(E, t.height + d + N),
                Math.max(0, c - (H + K)),
                Q - (f + I),
                is.BOTTOM_RIGHT
              )
            : new ts(t.left + t.width - (H + K), t.top + t.height - (f + I))),
        (this.bottomLeftContentBox =
          0 < w || 0 < U
            ? ws(t.left + p + T, t.top + F, Math.max(0, w - (p + T)), U - (f + I), is.BOTTOM_LEFT)
  ...
  var ws = function(A, e, t, r, n) {
    ...
    Es =
      ((hs.prototype.getParentEffects = function() {
  ...
  function Fs(A, e) {
    switch (e) {
      case 0:
        return ms(A.topLeftBorderBox, A.topLeftPaddingBox, A.topRightBorderBox, A.topRightPaddingBox);
      case 1:
        return ms(A.topRightBorderBox, A.topRightPaddingBox, A.bottomRightBorderBox, A.bottomRightPaddingBox);
      case 2:
        return ms(A.bottomRightBorderBox, A.bottomRightPaddingBox, A.bottomLeftBorderBox, A.bottomLeftPaddingBox);
      case 3:
      default:
        return ms(A.bottomLeftBorderBox, A.bottomLeftPaddingBox, A.topLeftBorderBox, A.topLeftPaddingBox);
    }
  }
  function ds(A) {
    var e = A.bounds,
  ...
  function fs(A, e, t) {
    var r = (function(A, e) {
        return 0 === A ? e.bounds : 2 === A ? Hs(e) : ds(e);
      })(Ls(A.styles.backgroundOrigin, e), A),
      n = (function(A, e) {
        return A === Ee.BORDER_BOX ? e.bounds : A === Ee.CONTENT_BOX ? Hs(e) : ds(e);
    ...
    return [
      Os(Ls(A.styles.backgroundRepeat, e), i, B, r, n),
  ...
  var Ks = function(c, Q, u, w) {
      c.container.elements.forEach(function(A) {
        var e = $r(A.flags, 4),
          t = $r(A.flags, 2),
          r = new Es(A, c.getParentEffects());
        $r(A.styles.display, 2048) && w.push(r);
        var n = $r(A.flags, 8) ? [] : w;
        if (e || t) {
          var B = e || A.styles.isPositioned() ? u : Q,
            s = new gs(r);
          ...
          Ks(r, s, e ? s : u, n);
        } else A.styles.isInlineLevel() ? Q.inlineLevel.push(r) : Q.nonInlineLevel.push(r), Ks(r, Q, u, n);
        $r(A.flags, 8) && Is(A, n);
      });
    },
    Is = function(A, e) {
    ...
    Ts = function(A, e) {
      var t = [];
      return os(A) ? t.push(A.subdivide(0.5, !1)) : t.push(A), os(e) ? t.push(e.subdivide(0.5, !0)) : t.push(e), t;
    },
    ms = function(A, e, t, r) {
      var n = [];
      return (
    ...
    Rs = function(A, e, t) {
      ...
      if (i) {
        var u = 0,
          w = 0;
        return (
          qA(s) ? (u = ae(s, t.width)) : qA(o) && (w = ae(o, t.height)),
          ps(s) ? (u = w * B) : (o && !ps(o)) || (w = u / B),
          [u, w]
        );
      }
      var U = null,
      ...
      if (
        ...
        null === U || (o && !ps(o)) || (l = a && c ? (U / r) * n : t.height),
        null !== l && ps(s) && (U = a && c ? (l / n) * r : t.width),
        null !== U && null !== l)
      )
        return [U, l];
    ...
    bs =
      ((vs.prototype.parseMetrics = function(A, e) {
        ...
        (t.style.visibility = 'hidden'),
          ...
          (n.style.margin = '0'),
          (n.style.padding = '0'),
          n.appendChild(this._document.createTextNode(Ds)),
          t.appendChild(n),
          t.appendChild(r);
  ...
  var Ss =
    ((Ms.prototype.applyEffects = function(A, e) {
    ...
    (Ms.prototype.renderStack = function(e) {
      return a(this, void 0, void 0, function() {
        return S(this, function(A) {
          switch (A.label) {
            case 0:
    ...
    (Ms.prototype.renderTextWithLetterSpacing = function(t, A) {
      var r = this;
      0 === A
    ...
    (Ms.prototype.renderNodeContent = function(l) {
      return a(this, void 0, void 0, function() {
        var e, t, r, n, B, s, o, i, a, c, Q, u, w, U;
        return S(this, function(A) {
          switch (A.label) {
            case 0:
            ...
            case 7:
              return A.sent(), be.getInstance(this.options.id).error('Error loading image ' + e.src), [3, 8];
            case 8:
            ...
            case 11:
              return (
                A.sent(), be.getInstance(this.options.id).error('Error loading svg ' + e.svg.substring(0, 255)), [3, 12]
              );
            case 12:
            ...
            case 14:
              if (
                ...
                switch (
                  ...
                  (this.ctx.textAlign = xs(e.styles.textAlign)),
                  (U = Hs(e)),
                  (a = 0),
                  e.styles.textAlign)
                ) {
              ...
              if ((Q = e.styles.listStyleImage).type !== Pe.URL) return [3, 18];
              (u = void 0), (w = Q.url), (A.label = 15);
            case 15:
              return A.trys.push([15, 17, , 18]), [4, this.options.cache.match(w)];
            case 16:
              return (u = A.sent()), this.ctx.drawImage(u, e.bounds.left - (u.width + 10), e.bounds.top), [3, 18];
            case 17:
              return A.sent(), be.getInstance(this.options.id).error('Error loading list-style-image ' + w), [3, 18];
            case 18:
              return [3, 20];
            case 19:
              l.listValue &&
    ...
    (Ms.prototype.renderStackContent = function(C) {
      return a(this, void 0, void 0, function() {
        var e, t, r, n, B, s, o, i, a, c, Q, u, w, U, l;
        return S(this, function(A) {
          switch (A.label) {
            case 0:
            ...
            case 23:
              return Q < u.length ? ((l = u[Q]), [4, this.renderStack(l)]) : [3, 26];
            case 24:
              A.sent(), (A.label = 25);
            case 25:
              return Q++, [3, 23];
    ...
    (Ms.prototype.renderBackgroundImage = function(v) {
      return a(this, void 0, void 0, function() {
        var D, e, b, t, r, n;
        return S(this, function(A) {
          switch (A.label) {
            case 0:
              (D = v.styles.backgroundImage.length - 1),
                (e = function(e) {
                  var t, r, n, B, s, o, i, a, c, Q, u, w, U, l, C, g, E, h, F, d, H, f, p, N, K, I, T, m, R, L, O;
                  return S(this, function(A) {
                    switch (A.label) {
                      case 0:
                        if (e.type !== Pe.URL) return [3, 5];
                        (t = void 0), (r = e.url), (A.label = 1);
                      case 1:
                        return A.trys.push([1, 3, , 4]), [4, b.options.cache.match(r)];
                      case 2:
                        return (t = A.sent()), [3, 4];
                      case 3:
                        return (
                          A.sent(), be.getInstance(b.options.id).error('Error loading background-image ' + r), [3, 4]
                        );
                      case 4:
                        return (
                          t &&
                            ((n = fs(v, D, [t.width, t.height, t.width / t.height])),
                            (g = n[0]),
                            (f = n[1]),
                            (p = n[2]),
                            (F = n[3]),
                            (d = n[4]),
                            (l = b.ctx.createPattern(b.resizeImage(t, F, d), 'repeat')),
                            b.renderRepeat(g, l, f, p)),
                          [3, 6]
                        );
                      case 5:
                        !(function(A) {
                          return A.type === Pe.LINEAR_GRADIENT;
                        })(e)
                          ? (function(A) {
                              return A.type === Pe.RADIAL_GRADIENT;
                            })(e) &&
                            ((C = fs(v, D, [null, null, null])),
                            (g = C[0]),
                            (E = C[1]),
                            (h = C[2]),
                            (F = C[3]),
                            (d = C[4]),
                            (H = 0 === e.position.length ? [oe] : e.position),
                            (f = ae(H[0], F)),
                            (p = ae(H[H.length - 1], d)),
                            (N = (function(A, e, t, r, n) {
                              ...
                              switch (A.size) {
                                ...
                                case Bt.CLOSEST_CORNER:
                                  if (A.shape === rt.CIRCLE)
                                    ...
                                    var o =
                                        Math.min(Math.abs(t), Math.abs(t - n)) / Math.min(Math.abs(e), Math.abs(e - r)),
                                      i = Ke(r, n, e, t, !0),
                                      a = i[0],
                                      c = i[1];
                                    s = o * (B = Ne(a - e, (c - t) / o));
                              ...
                              return (
                                Array.isArray(A.size) &&
                                  ((B = ae(A.size[0], r)), (s = 2 === A.size.length ? ae(A.size[1], n) : B)),
                                [B, s]
                              );
                            })(e, f, p, F, d)),
                            (K = N[0]),
                            ...
                            0 < K &&
                              0 < K &&
                              ((T = b.ctx.createRadialGradient(E + f, h + p, 0, E + f, h + p, K)),
                              ...
                              (b.ctx.fillStyle = T),
                              K !== I
                                ? ((m = v.bounds.left + 0.5 * v.bounds.width),
                                  (R = v.bounds.top + 0.5 * v.bounds.height),
                                  (O = 1 / (L = I / K)),
                                  b.ctx.save(),
                                  b.ctx.translate(m, R),
                                  b.ctx.transform(1, 0, 0, L, 0, 0),
                                  b.ctx.translate(-m, -R),
                                  b.ctx.fillRect(E, O * (h - R) + R, F, d * O),
                                  b.ctx.restore())
                                : b.ctx.fill()))
                          : ((B = fs(v, D, [null, null, null])),
                            (g = B[0]),
                            (f = B[1]),
                            (p = B[2]),
                            (F = B[3]),
                            ...
                            (c = s[3]),
                            (Q = s[4]),
                            ((u = document.createElement('canvas')).width = F),
                            (u.height = d),
                            (w = u.getContext('2d')),
                            (U = w.createLinearGradient(i, c, a, Q)),
                            fe(e.stops, o).forEach(function(A) {
                              return U.addColorStop(A.stop, te(A.color));
                            }),
                            (w.fillStyle = U),
                            w.fillRect(0, 0, F, d),
                            0 < F && 0 < d && ((l = b.ctx.createPattern(u, 'repeat')), b.renderRepeat(g, l, f, p))),
                          (A.label = 6);
                      case 6:
                        return D--, [2];
                    }
                ...
                (b = this),
                (t = 0),
                (r = v.styles.backgroundImage.slice(0).reverse()),
                (A.label = 1);
            case 1:
    ...
    (Ms.prototype.renderSolidBorder = function(e, t, r) {
      return a(this, void 0, void 0, function() {
        return S(this, function(A) {
          return this.path(Fs(r, t)), (this.ctx.fillStyle = te(e)), this.ctx.fill(), [2];
        });
      });
    }),
    (Ms.prototype.renderDoubleBorder = function(r, n, B, s) {
      return a(this, void 0, void 0, function() {
        var e, t;
        return S(this, function(A) {
          switch (A.label) {
          ...
          switch (A.label) {
            case 0:
              return (
                ...
                (n = _s(Ls(e.backgroundClip, 0), c.curves)),
            ...
            case 3:
              return s < o.length
                ? (i = o[s]).style !== Ft.NONE && !ee(i.color) && 0 < i.width
                  ? i.style !== Ft.DASHED
                    ? [3, 5]
                    : [4, this.renderDashedDottedBorder(i.color, i.width, B, c.curves, Ft.DASHED)]
                  : [3, 11]
                : [3, 13];
            case 4:
              return A.sent(), [3, 11];
            case 5:
              return i.style !== Ft.DOTTED
                ? [3, 7]
                : [4, this.renderDashedDottedBorder(i.color, i.width, B, c.curves, Ft.DOTTED)];
            case 6:
              return A.sent(), [3, 11];
            case 7:
              return i.style !== Ft.DOUBLE ? [3, 9] : [4, this.renderDoubleBorder(i.color, i.width, B, c.curves)];
            case 8:
              return A.sent(), [3, 11];
            case 9:
    ...
    (Ms.prototype.renderDashedDottedBorder = function(g, E, h, F, d) {
      return a(this, void 0, void 0, function() {
        var e, t, r, n, B, s, o, i, a, c, Q, u, w, U, l, C;
        return S(this, function(A) {
          return (
            this.ctx.save(),
            (e = (function(A, e) {
            ...
            (t = Fs(F, h)),
            d === Ft.DASHED && (this.path(t), this.ctx.clip()),
            (n = os(t[0]) ? ((r = t[0].start.x), t[0].start.y) : ((r = t[0].x), t[0].y)),
            (s = os(t[1]) ? ((B = t[1].end.x), t[1].end.y) : ((B = t[1].x), t[1].y)),
            (o = 0 === h || 2 === h ? Math.abs(r - B) : Math.abs(n - s)),
            this.ctx.beginPath(),
            d === Ft.DOTTED ? this.formatPath(e) : this.formatPath(t.slice(0, 2)),
            (i = E < 3 ? 3 * E : 2 * E),
            (a = E < 3 ? 2 * E : E),
            d === Ft.DOTTED && (a = i = E),
            (c = !0),
            o <= 2 * i
              ...
              : o <= 2 * i + a
              ? ((i *= Q = o / (2 * i + a)), (a *= Q))
              : ((u = Math.floor((o + a) / (i + a))),
                (w = (o - u * i) / (u - 1)),
                (a = (U = (o - (u + 1) * i) / u) <= 0 || Math.abs(a - w) < Math.abs(a - U) ? w : U)),
            c && (d === Ft.DOTTED ? this.ctx.setLineDash([0, i + a]) : this.ctx.setLineDash([i, a])),
            d === Ft.DOTTED
            ...
            d === Ft.DASHED &&
              (os(t[0]) &&
                ...
                (C = t[0]),
                this.ctx.beginPath(),
                this.formatPath([new ts(l.end.x, l.end.y), new ts(C.start.x, C.start.y)]),
                this.ctx.stroke()),
              os(t[1]) &&
                ((l = t[1]),
                (C = t[2]),
              ...
              return (
                ...
                (e = (function(A) {
                  var e = new Es(A, []),
                    t = new gs(e),
                    r = [];
                  return Ks(e, t, t, r), Is(e.container, r), t;
                })(t)),
  ...
  function Ms(A) {
    (this._activeEffects = []),
      ...
      (this.fontMetrics = new bs(document)),
  ...
  var ys = function(A) {
      return A instanceof Zn || A instanceof Wn || (A instanceof Gn && A.type !== Vn && A.type !== Pn);
    },
    _s = function(A, e) {
      switch (A) {
        case Ee.BORDER_BOX:
    ...
    Ps =
      ((Vs.prototype.render = function(r) {
        return a(this, void 0, void 0, function() {
          var e, t;
          return S(this, function(A) {
            switch (A.label) {
  ...
  var Gs = function(p, N) {
    return a(void 0, void 0, void 0, function() {
      var e, t, r, n, B, s, o, i, a, c, Q, u, w, U, l, C, g, E, h, F, d, H, f;
      return S(this, function(A) {
        switch (A.label) {
          case 0:
            ...
            return (
              ...
              (Q = K({}, c, a, N)),
              (u = new I(Q.scrollX, Q.scrollY, Q.windowWidth, Q.windowHeight)),
              be.create({ id: r, enabled: Q.logging }),
              be.getInstance(r).debug('Starting document clone'),
              (w = new xB(p, {
                id: r,
                onclone: Q.onclone,
          ...
          case 1:
            return (
              (l = A.sent()),
              (C = e.documentElement ? zs(getComputedStyle(e.documentElement).backgroundColor) : de.TRANSPARENT),
              (g = e.body ? zs(getComputedStyle(e.body).backgroundColor) : de.TRANSPARENT),
              (E = N.backgroundColor),
              (h = 'string' == typeof E ? zs(E) : null === E ? de.TRANSPARENT : 4294967295),
              (F = p === e.documentElement ? (ee(C) ? (ee(g) ? h : g) : C) : h),
              (d = {
                id: r,
                cache: Q.cache,
                canvas: Q.canvas,
              ...
              Q.foreignObjectRendering
                ? (be.getInstance(r).debug('Document cloned, using foreign object rendering'), [4, new Ps(d).render(U)])
                : [3, 3]
            );
          case 2:
            return (H = A.sent()), [3, 5];
          case 3:
            return (
              be.getInstance(r).debug('Document cloned, using computed rendering'),
              Se.attachInstance(Q.cache),
              be.getInstance(r).debug('Starting DOM parsing'),
              (f = oB(U)),
              Se.detachInstance(),
              F === f.styles.backgroundColor && (f.styles.backgroundColor = de.TRANSPARENT),
              be.getInstance(r).debug('Starting renderer'),
              [4, new Ss(d).render(f)]
            );
          case 4:
            (H = A.sent()), (A.label = 5);
          case 5:
            return (
              !0 === Q.removeContainer &&
                (xB.destroy(l) ||
                  be.getInstance(r).error('Cannot detach cloned iframe as it is not in the DOM anymore')),
              be.getInstance(r).debug('Finished rendering'),
              be.destroy(r),
              Se.destroy(r),
              [2, H]
            );
